...
function applyOverlay(thumbnailElement, overlayImageURL, flip = false) {
    ...
    overlayImage.src = getRandomImageFromDirectory();
...
function applyOverlayToThumbnails() {
    ...
    thumbnailElements.forEach((thumbnailElement) => {
        applyOverlay(thumbnailElement, `${imagesPath}${1}.png`, false);
    });
}
...
function getRandomImageFromDirectory() {
    ...
    randomIndex = Math.floor(Math.random() * highestImageIndex);
